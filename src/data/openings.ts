...
const coreOpeningCourses: OpeningCourse[] = [
  ...
  },
  {
    ...
    plan: ['Ocupar el centro con e4.', 'Desarrollar Nf3 y Bc4.', 'Elegir entre d3 o c3-d4 según la respuesta negra.'],
    lines: [
      {
        id: 'italian-c3-d4',
        name: 'Giuoco Piano con c3 y d4',
        stage: 'Centro abierto',
        summary: 'La ruptura d4 transforma la ventaja de desarrollo en actividad central concreta.',
        whitePlan: ['Enrocar antes de abrir el centro.', 'Preparar d4 con c3.', 'Desarrollar Cc3 después de los cambios centrales.'],
        blackPlan: ['Presionar e4 con ...Cf6.', 'Enrocar antes de aceptar la ruptura.', 'Retirar el alfil a b6 conservando su diagonal.'],
        keyIdeas: ['Presión natural sobre f7.', 'c3 prepara d4.', 'El ataque llega después del desarrollo.'],
        moves: [
          { san: 'e4', explanation: 'Ocupa el centro y abre simultáneamente las diagonales de la dama y del alfil de rey.' },
          { san: 'e5', explanation: 'Las negras igualan presencia central y liberan sus piezas del flanco de rey.' },
          { san: 'Nf3', explanation: 'El caballo se desarrolla con tiempo porque ataca el peón negro de e5.' },
          { san: 'Nc6', explanation: 'Las negras defienden e5 mientras incorporan una pieza al control del centro.' },
          { san: 'Bc4', explanation: 'El alfil ocupa una diagonal activa, permite enrocar y señala la casilla f7.' },
          { san: 'Bc5', explanation: 'Las negras desarrollan de forma simétrica y ejercen presión sobre el punto f2.' },
          { san: 'O-O', explanation: 'El rey queda seguro antes de que la futura ruptura d4 abra líneas centrales.' },
      ...
      },
      {
        ...
        name: 'Pianissimo con d3',
        stage: 'Maniobra',
        summary: 'El centro estable concede tiempo para mejorar cada pieza antes de ejecutar d4.',
        whitePlan: ['Mantener e4 con d3.', 'Preparar d4 con c3 y Te1.', 'Llevar el caballo de b1 por d2-f1-g3.'],
        blackPlan: ['Construir con ...d6 y ...a6.', 'Retirar el alfil a a7 si es atacado.', 'Responder a d4 con ...d5 cuando esté preparado.'],
        keyIdeas: ['Centro cerrado y maniobras.', 'El caballo mejora por d2-f1-g3.', 'La ruptura d4 se prepara sin prisa.'],
        moves: [
          { san: 'e4', explanation: 'Las blancas ocupan una casilla central y liberan el alfil que irá a c4.' },
          { san: 'e5', explanation: 'Las negras establecen una estructura clásica y reclaman el mismo espacio central.' },
          { san: 'Nf3', explanation: 'El caballo ataca e5 y obliga a las negras a sostener correctamente su centro.' },
          { san: 'Nc6', explanation: 'Las negras desarrollan defendiendo e5, una respuesta eficiente de doble propósito.' },
          { san: 'Bc4', explanation: 'El alfil se activa sobre la diagonal italiana sin convertir f7 en un ataque automático.' },
          { san: 'Bc5', explanation: 'Las negras colocan su alfil fuera de la cadena y aumentan la presión sobre f2.' },
          { san: 'd3', explanation: 'Las blancas sostienen e4 y eligen una batalla de maniobras en un centro estable.' },
          { san: 'Nf6', explanation: 'El caballo negro entra con actividad y obliga a vigilar la defensa de e4.' },
          { san: 'O-O', explanation: 'La seguridad del rey precede a cualquier expansión o ruptura en el centro.' },
          { san: 'd6', explanation: 'Las negras consolidan e5 y abren el camino para desarrollar el alfil de c8.' },
          { san: 'c3', explanation: 'La jugada reserva d4 y también ofrece una retirada segura al alfil de c4.' },
          { san: 'O-O', explanation: 'Las negras completan la seguridad del rey antes de iniciar maniobras de flanco.' },
          { san: 'Re1', explanation: 'La torre refuerza e4 y queda preparada para la futura apertura de la columna e.' },
          { san: 'a6', explanation: 'Las negras ganan espacio y preparan ...Aa7 sin decidir todavía el centro.' }
        ]
      },
      {
        id: 'italian-two-knights',
        name: 'Dos Caballos: respuesta a ...Cf6',
        stage: 'Decisión táctica',
        summary: 'Ante ...Cf6 hay que reconocer cuándo la presión sobre f7 permite una línea forzada.',
        whitePlan: ['Atacar f7 sólo con cálculo concreto.', 'Responder a ...d5 sin aferrarse al peón.', 'Retirar el alfil conservando actividad.'],
        blackPlan: ['Golpear el centro con ...d5.', 'Ganar tiempos sobre las piezas adelantadas.', 'Completar desarrollo tras neutralizar la iniciativa.'],
        keyIdeas: ['...Cf6 ataca e4.', 'Cg5 exige cálculo, no memoria ciega.', '...d5 es la respuesta central liberadora.'],
        moves: [
          { san: 'e4', explanation: 'El peón central libera piezas y establece el terreno para una apertura abierta.' },
          { san: 'e5', explanation: 'Las negras ocupan el centro y aceptan una lucha simétrica por el desarrollo.' },
          { san: 'Nf3', explanation: 'El caballo se activa atacando e5 y prepara un enroque rápido del rey blanco.' },
          { san: 'Nc6', explanation: 'Las negras defienden e5 y controlan las casillas centrales d4 y e5.' },
          { san: 'Bc4', explanation: 'El alfil apunta a f7, pero la presión sólo es útil si las piezas coordinan.' },
          { san: 'Nf6', explanation: 'La Defensa de los Dos Caballos contraataca e4 en lugar de imitar con ...Ac5.' },
          { san: 'Ng5', explanation: 'El caballo suma presión sobre f7 y plantea una cuestión táctica inmediata.' },
          { san: 'd5', explanation: 'La respuesta correcta golpea el centro y abre líneas para frenar el ataque blanco.' },
          { san: 'exd5', explanation: 'Las blancas aceptan la tensión central y obligan al caballo negro a recolocarse.' },
          { san: 'Na5', explanation: 'El caballo ataca el alfil de c4 y evita recuperar de inmediato con la dama.' },
          { san: 'Bb5+', explanation: 'El jaque intermedio conserva la iniciativa y fuerza una respuesta de desarrollo.' },
          { san: 'c6', explanation: 'Las negras bloquean el jaque mientras atacan al alfil y sostienen el centro.' }
        ]
      }
    ]
  },
